...
namespace T4MVC
{
    ...
    public class HelpPageClass
    {
        ...
        public WebMVC1.Areas.HelpPage.Controllers.HelpController Help = new WebMVC1.Areas.HelpPage.Controllers.T4MVC_HelpController();
...
namespace Links
{
    ...
    public static class Content {
        ...
        public static class Image {
            ...
            public static string Url() { return T4MVCHelpers.ProcessVirtualPath(UrlPath); }
            public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(UrlPath + "/" + fileName); }
            public static readonly string Jiaxun_jpg = Url("Jiaxun.jpg");
        }
    ...
    public static partial class Bundles
    {
        public static partial class Scripts 
        {
            public static class Assets
            {
                ...
                public const string jquery_easyui_min_js = "~/Scripts/jquery.easyui.min.js"; 
        ...
        public static partial class Content 
        {
            ...
            public static class Assets
            {
                ...
                public const string datagrid_css = "~/Content/datagrid.css";
                public const string easyui_css = "~/Content/easyui.css";
